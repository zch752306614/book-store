<template>
	<view class="page-index" :style="paddingTop">
		<view class="index-top">
			<span class="top-setting">设置</span>
			<view class="top-main">
				<view class="main-left">
					<span class="main-hello">您好！愿轻松享受每一片段~</span>
					<span class="main-username">张星星</span>
				</view>
					...
					<view v-for="(item, index) in list" :key="index" class="list-one" @click="toBookread(item)">
						...
						<view class="read-one-main">
							...
							<view class="read-one-right">
								...
								<span class="book-name">{{item.novelName}}</span>
								<span class="book-author">{{item.novelAuthor}}</span>
							</view>
						</view>
					</view>
				</view>
